...
const CSVInstructions = () => {
  ...
  return (
    <div className="bg-white/95 rounded-lg shadow-sm p-5 sm:p-6 width-container border border-gray-100 flex-col-center">
      ...
      <div className="space-y-3 relative w-full max-w-lg mx-auto">
        {/* Progress Line */}
        ...
        {steps.map((step, index) => (
          ...
          >
            <div className={`flex-shrink-0 w-6 h-6 rounded-full flex-center text-xs shadow-sm transition-all duration-300 ${
              activeStep === index 
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1 text-xs sm:text-sm leading-relaxed text-left">
                {step.description}
              </p>
            </div>
          </div>
